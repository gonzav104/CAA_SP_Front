 ...
 * Owns únicamente el estado del drawer, el cierre al cambiar de ruta, el
 * cierre por Escape y el short-circuit de auth. Toda la presentación vive en
 * `./shell/*`, consumiendo `construirNavItems` como fuente única de items.
 */
export function DashboardLayout() {
  ...
  return (
    <div className="min-h-svh bg-muted/40">
      ...
      <MobileNavDrawer abierto={drawerAbierto} onCerrar={cerrarDrawer} items={items} />
